#Plot1 code
fileName <- file("G:/exdata_data_household_power_consumption/household_power_consumption.txt") 
...
plot(data$Global_active_power ~ DateTime1, type = "l",ylab="Global Active Power(kilowatt)",xlab="")
